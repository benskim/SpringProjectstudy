     ...
     <table class="table" width=600>
       <tr>
          ...
          <td width=85% class="text-left">
             ...
             <input type=text class="input" size=12 name=name value="${vo.name }">
       ...
       <tr>
          ...
          <td width=85% class="text-left">
             <input type=text class="input" size=40 name=subject value="${vo.subject }">
          </td>
       </tr>
       <tr>
          <td width=15% class="text-right">내용</td>
          <td width=85% class="text-left">
             <textarea rows="7" cols="45" name=content>${vo.content }</textarea>
          </td>
       </tr>
       <tr>
       ...
       <tr>
          <td colspan="2" class="text-center">
             <input type=submit value="수정" class="button btn-success">
