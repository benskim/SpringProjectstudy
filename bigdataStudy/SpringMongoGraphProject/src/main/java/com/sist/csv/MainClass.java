...
public class MainClass {
	...
	public static void main(String[] args){
		...
		try {
			CSVWriter cw = new CSVWriter(new FileWriter("/home/sist/movie_data/std1.csv"));
			List<String[]> csvList = new ArrayList<String[]>();
			for(StudentVO vo:list){
				String[] str = {
						vo.getName(),
						String.valueOf(vo.getKor()),
						String.valueOf(vo.getEng()),
						String.valueOf(vo.getMath()),
						String.valueOf(vo.getPhy())
				};
				csvList.add(str);
			}
			cw.writeAll(csvList);
