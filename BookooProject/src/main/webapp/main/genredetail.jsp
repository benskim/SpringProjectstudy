...
<body>
	...
	<div class="container">
		...
		<div class="container">
			<div class="row">
				<c:forEach var="vo" items="${rlist }" begin="0" end="17" varStatus="status">
				<div class="col-sm-2">
					<table style="width:150px">
						<tr><th>${vo.bookname }</th></tr>
						<tr><th><div class="gen_con"><img src="${imglist[status.index]}" style="width:150px; height: 290px;"></div></th></tr>
					</table>
