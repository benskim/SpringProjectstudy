...
Highcharts.chart('chart_container', {
    ...
    series: [{
        data: [169, 52, 46, 83, 67, 107, 233, 18, 24, 137]
    }, {
        data: [347511,332709,322918,291071,195896,153486,128196, 114190, 99007, 92813],
        yAxis: 1
    }]
			...
			<!-- 리스트 작가+저서 -->
			      ...
			      <div class="row writer_info">
			         ...
			         <div class="col-lg-7 writer_books">
			            <a href="detail.do?${vo.wbisbn1 }">
			               <div class="book_img_120">
			                  <img src="${vo.wbimg1 }">
			                  <br><span>${vo.wbtitle1 }</span>
			               </div>
			            </a>
			            <a href="detail.do?${vo.wbisbn2 }">
			               <div class="book_img_120">
			                  <img src="${vo.wbimg2 }">
			                  <br><span>${vo.wbtitle2 }</span>
			               </div>
			            </a>
			            <a href="detail.do?${vo.wbisbn3 }">
			               <div class="book_img_120">
			                  <img src="${vo.wbimg3 }">
			                  <br><span>${vo.wbtitle3 }</span>
			               </div>
			            </a>
			            <a href="detail.do?${vo.wbisbn4 }">
			               <div class="book_img_120">
			                  <img src="${vo.wbimg4 }">
			                  <br><span>${vo.wbtitle4 }</span>
			               </div>
			            </a>
			           <a href="detail.do?${vo.wbisbn5 }">
			               <div class="book_img_120">
			                  <img src="${vo.wbimg5 }">
